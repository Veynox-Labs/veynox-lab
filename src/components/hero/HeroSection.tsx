...
export default function HeroSection() {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex flex-col items-center">
      ...
      <div
        className="absolute top-1/3 right-1/4 w-96 h-96 bg-brand-neon/20 rounded-full blur-[100px] -z-10 animate-blob"
        style={{ animationDelay: "2s" }}
      />
      <div
        className="absolute bottom-1/4 left-1/2 w-96 h-96 bg-brand-deep/20 rounded-full blur-[100px] -z-10 animate-blob"
      ...
      <div className="max-w-7xl mx-auto px-6 text-center z-10">
        ...
        <motion.h1
          ...
          <span className="text-transparent bg-clip-text bg-linear-to-r from-brand-electric via-brand-neon to-brand-electric bg-size-[200%_auto] animate-[gradient_4s_linear_infinite]">
            Experiences
          </span>{" "}
        ...
        <motion.p
          ...
          We design and develop premium websites, landing pages, and digital
        ...
        <motion.div
          ...
          <button className="cursor-pointer w-full sm:w-auto px-8 py-4 rounded-full bg-white text-bg-main font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center gap-2">
            Start Your Project <ArrowRight size={18} />
          </button>
          <button className="cursor-pointer w-full sm:w-auto px-8 py-4 rounded-full bg-white/5 text-white font-semibold hover:bg-white/10 transition-colors border border-white/10 backdrop-blur-md flex items-center justify-center gap-2">
            Book a Consultation
          </button>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        <div className="relative rounded-2xl md:rounded-3xl border border-white/10 bg-bg-card backdrop-blur-xl shadow-2xl overflow-hidden transform-gpu hover:scale-[1.01] transition-transform duration-500 z-10">
          ...
          <div className="relative w-full aspect-video md:aspect-21/9">
            ...
            <div className="absolute inset-0 bg-linear-to-t from-bg-main/80 via-transparent to-transparent"></div>
          </div>
        </div>
        ...
        <motion.div
          ...
          className="absolute left-2 md:-left-16 bottom-10 md:bottom-20 z-20 w-52 md:w-60 p-4 rounded-xl bg-bg-main/80 backdrop-blur-xl border border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.4)] shadow-brand-electric/10">
          <div className="flex items-center gap-3">
        ...
        <motion.div
          ...
          className="absolute right-2 md:-right-12 top-4 md:top-12 z-20 w-48 md:w-56 p-4 rounded-xl bg-bg-main/80 backdrop-blur-xl border border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.4)] shadow-brand-deep/10">
          <div className="flex items-center gap-3">
        ...
        <motion.div
          ...
          className="absolute right-2 md:-right-16 bottom-16 md:bottom-24 z-20 w-52 md:w-64 p-4 rounded-xl bg-bg-main/80 backdrop-blur-xl border border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.4)] shadow-white/5">
          <div className="flex items-center gap-3">
      ...
      <motion.div
        ...
        <a
          href="#services"
          className="flex flex-col items-center gap-2 text-text-secondary hover:text-white transition-colors cursor-pointer group">
