...
const features = [
  {
    title: "Modern UI/UX",
    description:
      "Beautiful, intuitive designs that engage users and elevate your brand identity.",
    icon: Layout,
  },
  {
    title: "Fast Performance",
    description:
      "Optimized for speed and SEO, ensuring lightning-fast load times globally.",
    icon: Zap,
  },
  {
  ...
  },
  {
    ...
    description:
      "Tailored aesthetics specifically engineered for modern tech companies and SaaS.",
    icon: Target,
  },
  {
    title: "Cloud-Ready Deployment",
    description:
      "Secure and scalable architecture ready to handle your business growth.",
    icon: Cloud,
  },
];
...
export default function WhyChooseUsSection() {
  return (
    <section
      ...
      {/* Background Elements */}
      <div className="absolute right-0 top-0 w-1/2 h-full bg-linear-to-l from-brand-dark/5 to-transparent pointer-events-none"></div>
          ...
          <div>
            <motion.div
              ...
              <p className="text-text-secondary text-lg mb-8 max-w-lg">
                ...
                that drive growth, engage users, and position your brand as an
                industry leader.
              </p>
