...
export default function PortfolioSection() {
  return (
    <section id="portfolio" className="py-24 relative overflow-hidden bg-bg-secondary/50 border-y border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            >
              Featured <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-electric to-brand-neon">Work</span>
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              A selection of our recent projects showcasing our expertise in design and development.
            </motion.p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div className={`relative w-full aspect-video rounded-2xl overflow-hidden mb-6 ${project.image} border border-white/10`}>
                ...
                <div className="absolute inset-4 rounded-xl bg-bg-main/50 backdrop-blur-md border border-white/10 transform group-hover:scale-[1.02] transition-transform duration-500 overflow-hidden">
                  ...
                  <div className="p-6 opacity-50 flex items-center justify-center h-full">
                    <span className="font-heading text-2xl tracking-widest text-white/50 uppercase">{project.title}</span>
                  </div>
                </div>
              ...
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-brand-electric transition-colors">{project.title}</h3>
