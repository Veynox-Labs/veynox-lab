        ...
        >
          <div className="rounded-[23px] bg-bg-secondary/90 backdrop-blur-xl p-10 md:p-16 text-center border border-white/5 relative overflow-hidden">
            ...
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-white mb-6 tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-electric to-brand-neon">Exceptional</span>
            </h2>
            
            <p className="text-text-secondary text-lg md:text-xl mb-10 max-w-2xl mx-auto">
              Ready to elevate your digital presence? Partner with Veynox Labs and turn your vision into a stunning reality.
            </p>
            
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="w-full sm:w-auto px-8 py-4 rounded-full bg-white text-bg-main font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 text-lg">
                Start Your Project <ArrowRight size={20} />
              </button>
              <button className="w-full sm:w-auto px-8 py-4 rounded-full bg-white/5 text-white font-semibold hover:bg-white/10 transition-colors border border-white/10 backdrop-blur-md flex items-center justify-center gap-2 text-lg">
